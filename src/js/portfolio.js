...
[[;grey;]Welcome to TORRES OS ${Math.floor(new Date().getFullYear() / 100)}.${new Date().getFullYear() % 100}.${new Date().getMonth() + 1} LTS (GNU/Linux 5.15.0-105-generic x86_64)
...
[[; white;]Hey! Just e-mail me at 📨 mail@torres.swiss
